...
function Manage_Teacher() {
  ...
  return (
    <div className=' h-screen p-4 md:ml-64  pt-20 bg-gray-50 dark:bg-gray-900 p-3 sm:p-5'>
          {uplaod? <Sheet data={data}></Sheet>:(<div className="w-full flex flex-col justify-center items-center max-w-4xl mx-auto min-h-96 border border-dashed bg-white dark:bg-black border-neutral-200 dark:border-neutral-800 rounded-lg">
