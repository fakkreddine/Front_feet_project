                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                               <div className='flex gap-4 items-center'> 
                                ...
                                <div>
                                    <h2>Fakhri haj mbarek</h2>
                                    <p className='text-gray-400 font-normal'>Fakkreddine10@gmail.com</p>
                                </div>
                               </div>
      </th>
                            
                            <td class="px-4 py-3">12150186622</td>
                            <td class="px-4 py-3">rKDD1bKxtDaeYzqVflb4Iw657iB3</td>
                            <td class="px-4 py-3">12/3/20024</td>
                            <td>  <Badge status="success" /> Active</td>
