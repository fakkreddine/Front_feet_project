...
import rayen from "../assets/ryen.jpg"
...
import VelocityScroll from './dashcomp/scrollbasedvelocity';
...
function Init() {
    ...
    const countUp = (target, setCount) => {
      let current = 0;
      const stepTime = 30; // How fast the count increments
...
<section class="bg-white mt-5 dark:bg-gray-900">
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold dark:text-white">Designed for business teams like yours</h2>
          <p class="mb-5 font-light text-gray-300 sm:text-xl dark:text-gray-400">At SchoPlanner, we strive to provide affordable solutions that empower schools and institutions to optimize their schedules, streamline workflows, and unlock the full potential of education through innovation and technology</p>
      </div>
...
<section className="bg-white dark:bg-gray-900">
      <div className="max-w-screen-xl px-6 py-12 mx-auto text-center lg:py-16 lg:px-8">
        <dl className="grid max-w-screen-md gap-10 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
          <div className="flex flex-col items-center justify-center p-6 rounded-lg shadow-lg hover:scale-105 transition-all duration-300">
            <dt className="mb-4 text-4xl md:text-5xl font-extrabold text-blue-800">
              {count1}
              <span>M+</span>
            </dt>
  ...
  <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
      ...
      <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={fakhri} alt="Bonnie Avatar"/>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={ahmed} alt="Helene Avatar"/>
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={rayen} alt="Jese Avatar"/>
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Rayen Ln</a>
              </h3>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={houssem} alt="Joseph Avatar"/>
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={anes}/>
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  <a href="#">Anes Fkhih</a>
              </h3>
              <p>Mobile Developer</p>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
              <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={mahdi} alt="Neil Avatar"/>
              <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
    ...
    <footer class="p-4 bg-blue-800 text-white  sm:p-6 dark:bg-gray-800">
    <div class="mx-auto max-w-screen-xl">
        <div class="md:flex md:justify-between">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-400 dark:text-gray-100">
                        <li class="mb-4">
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm  sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com" class="hover:underline">SchoPlanner™</a>. All Rights Reserved.
            </span>
