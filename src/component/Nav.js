...
function Nav() {
  ...
  let items=[{
    key: '1',
    label: user.reloadUserInfo.displayName,
    extra: <span class="flex w-3 h-3 me-3 bg-green-500 rounded-full"></span>,
  },
  {
    type: 'divider',
  },
  {
    key: '2',
    label:   user.reloadUserInfo.providerUserInfo[0]?.email,
  ...
  },
  {
    ...
    extra: <img className="w-4 h-4" src={logouticon}/>,
  },
];
  return (
    ...
    <div class="flex flex-wrap justify-between items-center">
      ...
      <div class="flex items-center lg:order-2">
        ...
        >
          ...
          <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" area-hidden="true">
