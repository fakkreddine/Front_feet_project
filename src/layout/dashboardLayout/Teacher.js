...
import Actions_teacher from '../../component/Teashercomponent/Actions_teacher'


function Teacher() {
  let [tabs,settabs]=useState(<Overview_teasher></Overview_teasher>)
  return (
    <div>
...
<div class="p-4 md:ml-64  pt-20  border-b border-gray-200 dark:border-gray-700">
    <ul class="flex justify-center flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
        <li class="me-2 ">
            <button onClick={()=>{
                    settabs(<Overview_teasher></Overview_teasher>)
        ...
        <li class="me-2">
            <button  onClick={()=>{
                    settabs(<Manage_Teacher></Manage_Teacher>)
        ...
        <li class="me-2">
            <button  onClick={()=>{
                    settabs(<Actions_teacher></Actions_teacher>)
