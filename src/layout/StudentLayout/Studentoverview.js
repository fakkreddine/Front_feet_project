...
function Studentoverview({ data, department, setData ,relode}) { // Accept setData as a prop to update data externally
  ...
  const [defaulte,setdefault]=useState("!text-blue-600  border-blue-600")
...
const updteStudent=async()=>{
  ...
  return (
    ...
    <li class="me-2 ">
        <button onClick={()=>{
          settab(false)
        }}  class={` ${defaulte} ${!tab?"text-blue-600   !border-blue-600":"!border-gray-300"}  focus:text-blue-600  focus:border-blue-600 inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600  dark:hover:text-gray-300 group`}>
            <svg class={`${defaulte} ${!tab&&"!text-blue-600   border-blue-600"}      w-4 h-4 me-2 text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
    ...
    <li class="me-2">
        <button onClick={()=>{
          settab(true)
          setdefault("")
        }}    class={` ${tab?"text-blue-600   border-blue-600":"!border-gray-300"}   focus:text-blue-600   focus:border-blue-600 inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 border-gray-300 dark:hover:text-gray-300 group` }aria-current="page">
            <svg class={`${tab&&"text-blue-600   border-blue-600"} w-4 h-4 me-2  group-focus:text-blue-600 dark:text-blue-500`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 18">
